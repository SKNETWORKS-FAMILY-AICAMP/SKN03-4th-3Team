...
from langchain_my.chain import create_chain_llm 
    ...
    if prompt:
        ...
        if message:
            ...
            with st.chat_message(CHATBOT_ROLE.assistant.name):
                ...
                assistant_response = st.write_stream(create_chain_llm(prompt, message_history = st.session_state.messages))
                print("작동하는건가?")
